...
<body>
     <%
         ...
         string dynPassword = Request.Params.Get("dynPassword");
         ...
         string orderNo = Request.Params.Get("orderid");
         ...
         sendMsg.Append("<Message>")
                ...
                .Append("<dynPassword>").Append(dynPassword).Append("</dynPassword>")
                ...
                .Append("<orderNo>").Append(orderNo).Append("</orderNo>")
         ...
         if ("000000".Equals(retCode))
         {
             ...
             string orderNo1 = opResult.Item(0).SelectSingleNode("orderNo").InnerText.Trim();
             ...
             Response.Write("订单号：" + orderNo1 + "<br>");
