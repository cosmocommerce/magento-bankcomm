...
<body>
     <%
         ...
         string applyTime = Request.Params.Get("applyTime");
         string netType = Request.Params.Get("netType");

         string tranCode = "PY0302";   //交易码
         ...
         sendMsg.Append("<Message>")
                ...
                .Append("<applyTime>").Append(applyTime).Append("</applyTime>")
         ...
         if ("000000".Equals(retCode))
         {
             ...
             string sessionID = opResult.Item(0).SelectSingleNode("sessionID").InnerText.Trim();
             string retCode1 = opResult.Item(0).SelectSingleNode("retCode").InnerText.Trim();
             
             Response.Write("sessionID：" + sessionID + "<br>");
             Response.Write("动态密码：" + retCode1 + "<br>");
         }
